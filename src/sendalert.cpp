...
2. run securetagd with -printalert or -sendalert like this:
   /path/to/securetagd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.securetagpay.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/SecureTag Core:0.12.0.58/"));
