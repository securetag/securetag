...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid securetag address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid securetag address" in e.error['message'])
        ...
        # send 12 SECURETAG to msig addr
