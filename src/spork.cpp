...
std::map<int, int64_t> mapSporkDefaults = {
    ...
    {SPORK_5_INSTANTSEND_MAX_VALUE,          1000},          // 1000 SecureTag
    {SPORK_6_NEW_SIGS,                       4070908800ULL}, // OFF
    {SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT, 4070908800ULL}, // OFF
    {SPORK_9_FUNDAMENTALNODE_PAYMENT_ENFORCEMENT, 4070908800ULL}, // OFF
    {SPORK_10_SUPERBLOCKS_ENABLED,            4070908800ULL}, // OFF
    {SPORK_11_MASTERNODE_PAY_UPDATED_NODES,  4070908800ULL}, // OFF
    {SPORK_12_FUNDAMENTALNODE_PAY_UPDATED_NODES,  4070908800ULL}, // OFF
    {SPORK_13_RECONSIDER_BLOCKS,             0},             // 0 BLOCKS
    {SPORK_15_REQUIRE_SENTINEL_FLAG,         4070908800ULL}, // OFF
...
void CSporkManager::ExecuteSpork(int nSporkID, int nValue)
{
    ...
    if(nSporkID == SPORK_13_RECONSIDER_BLOCKS && nValue > 0) {
...
int CSporkManager::GetSporkIDByName(const std::string& strName)
{
    ...
    if (strName == "SPORK_9_FUNDAMENTALNODE_PAYMENT_ENFORCEMENT")    return SPORK_9_FUNDAMENTALNODE_PAYMENT_ENFORCEMENT;
    if (strName == "SPORK_10_SUPERBLOCKS_ENABLED")               return SPORK_10_SUPERBLOCKS_ENABLED;
    if (strName == "SPORK_11_MASTERNODE_PAY_UPDATED_NODES")     return SPORK_11_MASTERNODE_PAY_UPDATED_NODES;
    if (strName == "SPORK_12_FUNDAMENTALNODE_PAY_UPDATED_NODES")     return SPORK_12_FUNDAMENTALNODE_PAY_UPDATED_NODES;
    if (strName == "SPORK_13_RECONSIDER_BLOCKS")                return SPORK_13_RECONSIDER_BLOCKS;
    if (strName == "SPORK_15_REQUIRE_SENTINEL_FLAG")            return SPORK_15_REQUIRE_SENTINEL_FLAG;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_9_FUNDAMENTALNODE_PAYMENT_ENFORCEMENT:    return "SPORK_9_FUNDAMENTALNODE_PAYMENT_ENFORCEMENT";
        case SPORK_10_SUPERBLOCKS_ENABLED:               return "SPORK_10_SUPERBLOCKS_ENABLED";
        case SPORK_11_MASTERNODE_PAY_UPDATED_NODES:     return "SPORK_11_MASTERNODE_PAY_UPDATED_NODES";
        case SPORK_12_FUNDAMENTALNODE_PAY_UPDATED_NODES:     return "SPORK_12_FUNDAMENTALNODE_PAY_UPDATED_NODES";
        case SPORK_13_RECONSIDER_BLOCKS:                return "SPORK_13_RECONSIDER_BLOCKS";
        case SPORK_15_REQUIRE_SENTINEL_FLAG:            return "SPORK_15_REQUIRE_SENTINEL_FLAG";
