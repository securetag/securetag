...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            if(ptrCategory->count(string("securetag"))) {
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\SecureTagCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\SecureTagCore
    // Mac: ~/Library/Application Support/SecureTagCore
    // Unix: ~/.securetag
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SecureTagCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/SecureTagCore";
#else
    // Unix
