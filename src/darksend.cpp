...
{
    if(fLiteMode) return; // ignore all SecureTag related functionality
...
/*
    ...
    allow endless transaction that would bloat SecureTag and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("securetag-privatesend");
