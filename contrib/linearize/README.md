# Linearize
Construct a linear, no-fork, best version of the SecureTag blockchain. The scripts
...
JSON-RPC server. Running `securetagd` or `securetag-qt -server` will be sufficient.
...
* `input`: securetagd blocks/ directory containing blkNNNNN.dat
