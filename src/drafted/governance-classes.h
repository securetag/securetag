 ...
 *
 *   // network
 *   CSecureTagNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.securetag.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSecureTagNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSecureTagNetwork(UniValue objIn)
    {
...
// // can be under: SecureTagNetwork
// //   -- signature requirements : Key1(User)
// class CSecureTagNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == SecureTagNetwork);
//     // }
