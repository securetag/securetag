...
SecureTag is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as SecureTag, where everyone uses
...
pay attention to for reviewers of SecureTag code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: SecureTag uses tinyformat, which is type safe. Leave them out to avoid confusion
