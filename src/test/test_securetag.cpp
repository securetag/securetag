...
#define BOOST_TEST_MODULE SecureTag Test Suite

#include "test_securetag.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_securetag_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
