...
* WebSocket: [https://github.com/securetagcoin/insight-api-securetag#web-socket-api](https://github.com/securetagcoin/insight-api-securetag#web-socket-api) 
* API: [https://github.com/securetagcoin/insight-api-securetag#instantsend-transactions](https://github.com/securetagcoin/insight-api-securetag#instantsend-transactions) 
...
By default, the SecureTag daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SecureTag daemon:
