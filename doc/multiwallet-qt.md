...
Only requiring some minor changes is securetag.cpp.
...
Changes to securetag.cpp
----------------------
securetag.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
