    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("SecureTag") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About SecureTag"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  securetag-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the SecureTag in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://securetagcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://securetagcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("SecureTag is shutting down...") + "<br /><br />" +
