/* src/config/securetag-config.h.  Generated from securetag-config.h.in by configure.  */
/* src/config/securetag-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SECURETAG_CONFIG_H

#define SECURETAG_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The SecureTag Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "SecureTag Core"
...
#define PACKAGE_BUGREPORT "https://github.com/securetagpay/securetag/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SecureTag Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SecureTag Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "securetag"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://securetagpay.org/"
