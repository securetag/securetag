...
This mechanism has been integrated into Bitcore-Node-SecureTag which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/securetagpay/insight-api-securetag#web-socket-api](https://github.com/securetagpay/insight-api-securetag#web-socket-api)
* API: [https://github.com/securetagpay/insight-api-securetag#instantsend-transactions](https://github.com/securetagpay/insight-api-securetag#instantsend-transactions)
...
By default, the SecureTag Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SecureTag Core daemon:
