...
Below are some notes on how to build SecureTag Core for Windows.
...
way. This will install to `c:\workspace\securetag`, for example:

    make install DESTDIR=/mnt/c/workspace/securetag
