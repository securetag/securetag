...
#if defined(NDEBUG)
# error "SecureTag cannot be compiled without assertions."
#endif
...
if (nPrevHeight == 0){
        return 800000 * COIN;
		    ...
		    nSubsidy = 14 * COIN;
    } else if(nPrevHeight >= 172901 && nPrevHeight <= 259300) {
		    nSubsidy = 12 * COIN;
    } else if(nPrevHeight >= 259301 && nPrevHeight <= 516000) {
                    nSubsidy = 10 * COIN;
    } else if(nPrevHeight >= 516001 && nPrevHeight <= 772700) {
		    nSubsidy = 8 * COIN;
    } else if(nPrevHeight >= 772701 && nPrevHeight <= 1286100) {
		    nSubsidy = 6 * COIN;
    } else if(nPrevHeight >= 1286101 && nPrevHeight <= 2000000) {
		    nSubsidy = 4 * COIN;
}  else {
		nSubsidy = 0 * COIN; }
...
} else if (nHeight >= 86501 && nHeight <= 516000) {
