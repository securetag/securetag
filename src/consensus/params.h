...
struct Params {
    ...
    int nFundamentalnodePaymentsStartBlock;
    int nFundamentalnodePaymentsIncreaseBlock;
    int nFundamentalnodePaymentsIncreasePeriod; // in blocks
    ...
    int nFundamentalnodeMinimumConfirmations;
