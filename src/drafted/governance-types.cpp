...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SecureTagNetwork") type = SecureTagNetwork;
    if(strType == "SecureTagNetworkVariable") type = SecureTagNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SecureTagNetwork) s = "SecureTagNetwork";
    if(type == SecureTagNetworkVariable) s = "SecureTagNetworkVariable";
