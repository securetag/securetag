...
official/supported Docker Images found at https://hub.docker.com/r/securetagpay/securetagd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/securetagpay/securetagd-develop/ when changing the above text**