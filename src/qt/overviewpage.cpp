...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
            QAbstractItemDelegate(), unit(BitcoinUnits::STG),
...
void OverviewPage::setBlockChainInfo(int count, const QDateTime& blockDate, double nVerificationProgress, bool headers)
{
    ...
    if (Params().GetConsensus().nLastPoWBlock > count) {
        ...
        ui->labelStakeStatus->setText(tr("<font color='darkred'>MN/FN list not synced</font>") );
    //} else if (!fundamentalnodeSync.IsSynced()) {
        //ui->labelStakeStatus->setText(tr("<font color='darkred'>Fundamentalnode list not synced</font>") );
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("SECURETAG")
        updateDisplayUnit();
...
void OverviewPage::updateDisplayUnit()
{
    if(walletModel && walletModel->getOptionsModel())
    {
        ...
        // Fundamentalnode List Status
        //ui->labelFnList->setText(tr("<font color='darkred'>syncing...</font>") );
        // Gobject List Status
...
void OverviewPage::showOutOfSyncWarning(bool fShow)
{
    ...
    if (!fShow) {
        ...
        if (fundamentalnodeSync.IsFundamentalnodeListSynced()) {
            ui->labelFnList->setText(tr("<font color='darkgreen'>ready</font>") );
        } else if (fundamentalnodeSync.IsFailed()) {
            ui->labelFnList->setText(tr("<font color='darkred'>failed</font>") );
        }
        */
    }
