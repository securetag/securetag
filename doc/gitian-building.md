...
*Setup instructions for a Gitian build of SecureTag using a Debian VM or physical system.*
...
- [Building SecureTag](#building-securetag-core)
...
Clone the git repositories for SecureTag and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/securetagcoin/securetag
```
...
in the SecureTag repository under 'Fetch and build inputs' to install sources which require
...
To build SecureTag (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the SecureTag repository.
...
```bash
    ...
    From https://github.com/securetagcoin/securetag
...
BTCPATH=/some/root/path/securetag.git
SIGPATH=/some/root/path/securetag-detached-sigs.git
...
[securetag/gitian.sigs](https://github.com/securetagcoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
